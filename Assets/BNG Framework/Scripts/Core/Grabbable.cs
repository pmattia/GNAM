    ...
    public class Grabbable : MonoBehaviour {
        ...
        public virtual void Update() {
            ...
            if (remoteGrabbing) {
                ...
                Transform grabPoint = GetClosestGrabPoint(flyingTo);
                Vector3 grabberPosition = GetGrabberWithGrabPointOffset(flyingTo, grabPoint);
                ...
                // Getting close so speed up
                    ...
                    movePosition(Vector3.MoveTowards(transform.position, grabberPosition, Time.deltaTime * GrabSpeed * 2f));
                    moveRotation(Quaternion.Slerp(transform.rotation, remoteRotation, Time.deltaTime * GrabSpeed * 2f));
                }
                // Normal Lerp
                else {
            ...
            if (GrabMechanic == GrabType.Snap) {
                ...
                if (g != null) {
                    ...
                    // Position the object in world space using physics
                        ...
                        Vector3 grabbablePosition = transform.position;
                        movePosition(Vector3.Lerp(grabbablePosition, destination, fractionOfJourney));
